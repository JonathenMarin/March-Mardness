...
{\centering \includegraphics[width=\textwidth]{figure/vif_mc-1} 

}

\caption[VIF Plots for the Men's (left) and Women's (right) Monte Carlo Linear Regression Models]{VIF Plots for the Men's (left) and Women's (right) Monte Carlo Linear Regression Models.}\label{fig:vif_mc}
\end{figure}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[H]
\includegraphics[width=\linewidth]{figure/conf_matrices_2025-1} \caption[Confusion Matrices for the 2025 Logistic Regression Model]{Confusion Matrices for the 2025 Logistic Regression Model}\label{fig:conf_matrices_2025}
\end{figure}
