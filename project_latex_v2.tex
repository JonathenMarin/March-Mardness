...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[H]
\includegraphics[width=\linewidth]{figure/conf_matrices_2025-1} \caption[..]{...}\label{fig:conf_matrices_2025}
\end{figure}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}[H]
\includegraphics[width=\linewidth]{figure/conf_matrix_xgb-1} \caption[Confusion Matrices for the 2025 XGBoost Model]{Confusion Matrices for the 2025 XGBoost Model.}\label{fig:conf_matrix_xgb}
\end{figure}
